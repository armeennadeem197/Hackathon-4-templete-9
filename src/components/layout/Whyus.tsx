    ...
    <div className="w-full h-[716px] flex mt-[100px] lg:px-[100px] overflow-hidden px-[20px]">
      ...
      <div className="flex flex-col lg:gap-[90px]">
        <div className="flex flex-col justify-between lg:gap-[20px]">
          <h1 className="text-yellow-600 font-greatVibes text-[32px] leading-[40px] font-medium">Why Choose us</h1>
          <h1 className="font-helvetica w-[400px] font-bold lg:text-[40px] text-[30px] leading-[45px] text-white">
            <span className="text-yellow-600">Ex</span>traordinary taste And Experienced
          </h1>
          <p className="font-normal lg:text-[16px] text-[13px] leading-6 text-white w-[280px] lg:w-[480px] lg:h-[48px]">
        ...
        <div className="lg:w-[374px] text-xs lg:h-[135px] h-[90px] flex lg:gap-[20px] gap-3">
          <h1 className="text-white text-center font-medium">
            <PiHamburgerLight className="lg:w-[102px] lg:h-[100px] h-10 w-10 rounded-[6px] bg-bordercoloryello text-whitetext text-center" />
            Fast Food
          </h1>
          <h1 className="text-white text-center font-medium">
            <PiCookieLight className="lg:w-[102px] lg:h-[100px] h-10 w-10 rounded-[6px] bg-bordercoloryello text-whitetext text-center" />
            Lunch
          </h1>
          <h1 className="text-white text-center font-medium">
            <GiWineGlass className="text-xs lg:w-[102px] w-10 lg:h-[100px] h-10 rounded-[6px] bg-bordercoloryello text-whitetext text-center" />
            Dinner
          </h1>
        </div>
        ...
        <div className="lg:w-[304px] w-[200px] flex gap-[20px] lg:px-[50px] lg:py-[20px] h-[93px] rounded-[6px] bg-white">
          <div>
            <h1 className="font-bold leading-[56px] text-[48px] text-yellow-600">30+</h1>
          </div>
          <div>
            <h1>Year of</h1>
            <h1 className="font-bold leading-[32px] text-black">Experienced</h1>
          </div>
        </div>
      </div>
    </div>

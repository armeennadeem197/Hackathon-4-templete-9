  ...
  return (
    <div className="mt-[100px]">
      ...
      <h1 className="text-center font-helvetica font-bold text-[32px] md:text-[40px] leading-[38px] md:leading-[45px] text-white">
        <span className="text-yellow-600">La</span>test News & Blog
      </h1>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
                ...
                <div className="px-4 md:px-[30px] flex justify-between">
                  ...
                  <div className="flex gap-[6px] md:gap-[10px] text-whitetext text-[16px] md:text-[18px]">
                    <MdThumbUpOffAlt className="text-white hover:text-bordercoloryello cursor-pointer" />
                    <LiaCommentDotsSolid className="text-white hover:text-bordercoloryello cursor-pointer" />
                    <LuShare2 className="text-white hover:text-bordercoloryello cursor-pointer" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
                ...
                <div className="px-4 md:px-[30px] flex justify-between">
                  ...
                  <div className="flex gap-[6px] md:gap-[10px] text-white text-[16px] md:text-[18px]">
                    <MdThumbUpOffAlt className="text-white hover:text-yellow-600 cursor-pointer" />
                    <LiaCommentDotsSolid className="text-white hover:text-bordercoloryello cursor-pointer" />
                    <LuShare2 className="text-white hover:text-bordercoloryello cursor-pointer" />
                  </div>
                </div>
            ...
            <div className="p-4 w-[300px] sm:w-[300px] h-auto sm:h-[379px]">
              <div className="h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
                ...
                <div className="px-4 md:px-[30px] flex justify-between">
                  ...
                  <div className="flex gap-[6px] md:gap-[10px] text-white text-[16px] md:text-[18px]">
                    <MdThumbUpOffAlt className="text-whitetext hover:text-yellow-600 cursor-pointer" />
                    <LiaCommentDotsSolid className="text-whitetext hover:text-yellow-600 cursor-pointer" />
                    <LuShare2 className="text-whitetext hover:text-yellow-600 cursor-pointer" />
                  </div>
                </div>
              </div>
            </div>

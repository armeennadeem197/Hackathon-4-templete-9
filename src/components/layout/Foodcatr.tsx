...
const Foodcatr = () => {
  return (
    ...
    <h1 className='text-yellow-600 text-center font-greatVibes lg:text-[32px] text-[30px] leading-[40px] font-bold'>Food Category</h1>
    <h1 className='font-helvetica  font-bold text-center lg:text-[40px] text-[30px] leading-[45px] text-white'><span className='text-yellow-600'>Ch</span>oose Food Iteam</h1>
